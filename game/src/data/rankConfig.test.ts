...
// Regression guard for the hand-authored Cubicle Survivor design tables, same spirit as the old
// levels.test.ts: keep these numbers honest since gameplay code trusts them blindly.
describe('rankConfig', () => {
  it('matches the Cubicle Survivor age-rank table', () => {
  ...
  it('matches the Cubicle Survivor parry window table', () => {
